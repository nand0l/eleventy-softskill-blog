---
title: Tutorial - Build a Hello World REST API with Lambda proxy integration
date: 2023-10-12
Author: admin
image: s3-bucket003.jpg
description: Learn how to build a 'Hello World' REST API using Lambda proxy integration. This tutorial guides you through creating a Lambda function and integrating it with an API Gateway. Dive in to understand the flexibility and efficiency of Lambda proxy integration. Perfect for beginners looking to get started with AWS services.
tags:
  - Amazon Api Gateway
  - Amazon Lambda
  - Under Construction
---
## THIS PAGE IS STILL UNDER CONSTUCTION
...
- [THIS PAGE IS STILL UNDER CONSTUCTION](#this-page-is-still-under-constuction)
- [THIS PAGE IS STILL UNDER CONSTUCTION](#this-page-is-still-under-constuction-1)
  - [Tutorial: Build a Hello World REST API with Lambda proxy integration](#tutorial-build-a-hello-world-rest-api-with-lambda-proxy-integration)
  - [Create a "Hello, World!" Lambda function](#create-a-hello-world-lambda-function)
  - [Create a "Hello, World!" API](#create-a-hello-world-api)
  - [Deploy and test the API](#deploy-and-test-the-api)
        - [Use browser and cURL to test an API with Lambda proxy integration](#use-browser-and-curl-to-test-an-api-with-lambda-proxy-integration)
